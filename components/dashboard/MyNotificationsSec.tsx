  ...
  <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-gray-800 font-semibold">
            John Doe <span className="text-sm text-gray-500">sent you a friend request</span>
          </p>
    ...
    <div className="flex justify-between items-center bg-white p-4 rounded-md shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-gray-800 font-semibold">
            Jane Smith <span className="text-sm text-gray-500">commented on your post</span>
          </p>
    ...
    <div className="flex justify-between items-center bg-white p-4 rounded-md shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-gray-800 font-semibold">
            Mark Lee <span className="text-sm text-gray-500">liked your photo</span>
          </p>
