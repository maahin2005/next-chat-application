...
const Upcoming: React.FC = () => {
  ...
  return (
    <div className="bg-[#F8F8FA] min-h-[400px] w-full flex items-center">
      <div className="w-full lg:w-5/6 m-auto flex flex-wrap md:gap-[8%] justify-center lg:gap-[12%] h-full items-center py-5">
        <div className="relative md:w-[40%] w-[90%] sm:w-[75%] lg:w-[40%] lg:max-w-[500px] h-[300px]">
          <Image
            src={videoGirlImg}
            width={450}
            height={300}
          ...
          <div className="absolute flex items-center bottom-0 z-20 w-full lg:h-[60px] sm:h-[50px] m-auto px-12">
            {videoCallIcons.map((el, i): any => (
              <div className="m-auto" key={i}>
                <Image
                  src={el}
                  ...
                  height={45}
                  alt="Black Overlay"
                  className="lg:w-[90%] md:w-[70%] w-[80%]"
                />
              </div>
            ))}
          </div>
        </div>
        <div className="min-h-[250px] md:w-[40%] lg:w-[45%] w-[90%] sm:w-[75%] mt-10 md:mt-0">
          <h1 className="lg:text-5xl md:text-4xl text-3xl font-bold mb-5">
            Meet your friends, <br /> with live video chat
          </h1>
          <p>
