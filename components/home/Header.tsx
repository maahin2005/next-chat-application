...
const LandingPage: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center p-6 lg:p-12 border">
      <div className="w-full lg:w-1/2 mb-6 lg:mb-0  lg:mr-20 border">
        <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-4 font-kanit">
